...
function mapResultsForTable(dbResults) {
    return __awaiter(this, void 0, void 0, function () {
        var keys, fields, headers, i, field, rows;
        return __generator(this, function (_a) {
            keys = dbResults.records[0].keys;
            fields = dbResults.records[0]._fields;
            headers = [];
            ...
            for (i = 0; i < fields.length; i++) {
                ...
                if (!field.properties) {
                    ...
                    Object.keys(field.properties).forEach(function (p) {
                        if (!headers[p]) {
                            headers.push(p);
                        }
                    });
            ...
            rows = [];
            dbResults.records.forEach(function (r) {
                var tableRow = [];
                r._fields.forEach(function (field) {
                    // populate the table row with properties
                    if (!field.properties) {
                        tableRow.push(field);
                    }
                    else {
                        Object.values(field.properties).forEach(function (value) {
                            tableRow.push(value);
                        });
                    }
                });
